...
- [ ] **A11** — Browser notifications for spread alerts: Bell button with threshold presets (>5%/>10%/>20%); fires a native browser notification when auto-scan finds a new pair exceeding the threshold; de-duplicated per session to avoid spam
